...
// InterfacePath is a partial implementation of the snet.Path interface for
// situations where snet.Path is officially required by external code but only
// the path interfaces are actually needed and accessed behind the scenes.
